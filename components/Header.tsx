...
export default function Header({ user, activePage }: HeaderProps) {
  ...
  return (
    <header className="fixed top-0 left-0 right-0 w-full py-2.5 bg-background/95 backdrop-blur-md border-b border-border/40 text-foreground z-[60] shadow-sm">
          ...
          <div className="flex items-center gap-4">
            <nav className="flex gap-1.5">
              <button
                ...
                className={`px-3.5 cursor-pointer py-1.5 rounded-md text-sm font-medium transition-all ${
